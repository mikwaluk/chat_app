...
class SimpleServer {
    ...
    , user_manager_ {} {
        ...
        const std::string server_pull_socket_address = std::string("tcp://") + server_host + std::string(":") + server_pull_port;
        const std::string server_pub_socket_address = std::string("tcp://") + server_host + std::string(":") + server_pub_port;
        const std::string server_rep_socket_address = std::string("tcp://") + server_host + std::string(":") + server_resp_port;
