...
int main(int argc, char* argv[]) {
  ...
  desc.add_options()("help,h", "produce help message")(
      ...
      "Server port to pull messages")("sub_port,s", po::value<std::string>(&server_pub_port)->default_value("8001"),
  ...
  const std::string full_server_pub_address = std::string("tcp://") + server_host + std::string(":") + server_pub_port;
