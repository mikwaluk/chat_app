...
// It checks for each user stored in user_activity_map_, if it has reached its activity timeout,
// and removes that user from the map if so.
...
// Resets the activity timeout for a specific user
